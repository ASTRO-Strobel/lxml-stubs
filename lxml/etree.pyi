...
class XPath:
    def __init__(self, path: _AnyStr, namespaces: Optional[_AnyStr] = None, extensions: Optional[_AnyStr] = None, regexp: Optional[bool] = None, smart_strings: Optional[bool] = None) -> None: ...
