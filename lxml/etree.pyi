...
class XPath:
    def __init__(self, path: _AnyStr, namespaces: Optional[Union[_AnyStr, _DictAnyStr]] = None, extensions: Optional[_AnyStr] = None, regexp: Optional[bool] = None, smart_strings: Optional[bool] = None) -> None: ...
